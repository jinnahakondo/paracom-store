            ...
            <Carousel className="w-full ">
                <CarouselContent className="-ml-4 lg:-ml-10">
                    {categories.map((category: categoryType) => (
                        <CarouselItem key={category._id} className="basis-1/3 pl-4 lg:pl-10 sm:basis-1/4 md:basis-1/5 lg:basis-1/7 flex flex-col items-center justify-center gap-4 ">
